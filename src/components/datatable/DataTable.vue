  ...
  <table class="table align-middle table-row-dashed fs-6 gy-5" id="">
    <thead>
      <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
        <th class="w-10px pe-2" v-if="checkBox">
          <div
        ...
        <th class="min-w-125px" v-for="field in fields" :key="field.key">
          {{ field.label }}
        </th>
        <th class="min-w-100px text-end" v-if="action">Actions</th>
      </tr>
    </thead>
    <tbody class="fw-bold text-gray-600">
      <!-- <tr v-if="items.length == 0">
        <td colspan="100%"><center>Table is Empty</center></td>
      </tr> -->
